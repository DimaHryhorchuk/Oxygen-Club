        ...
        var c,
          ...
          m = {
            cancelScroll: function (e) {
              cancelAnimationFrame(v), (v = null), e || a("scrollCancel", c);
            },
          };
        m.animateScroll = function (o, s, n) {
          var d = i(c || t, n || {}),
            p = "[object Number]" === Object.prototype.toString.call(o),
            f = p || !o.tagName ? null : o;
          if (p || f) {
            var g = e.pageYOffset;
            ...
            var y,
              ...
              S = p
                ...
                : (function (t, i, o, s) {
                    ...
                    h,
                    parseInt(
                      "function" == typeof d.offset ? d.offset(o, s) : d.offset,
                      10
                    ),
                    d.clip
                  ),
              ...
              C = function (t) {
                y || (y = t),
                  ...
                  (function (t, i) {
                    var n = e.pageYOffset;
                    if (t == i || n == i || (g < i && e.innerHeight + n) >= b)
                      return (
                        m.cancelScroll(!0),
                        (function (t, i, o) {
                  ...
                  })(w, S) || ((v = e.requestAnimationFrame(C)), (y = t));
              };
        ...
        var g = function (t) {
            if (
              ...
              (r = r || "#top" !== i ? r : document.documentElement) &&
                (t.preventDefault(), m.animateScroll(r, p));
            }
          },
          y = function (e) {
            if (
              ...
              var t = document.querySelector(n(s(history.state.anchor)));
              t && m.animateScroll(t, null, { updateURL: !1 });
            }
          },
          k = function (e) {
            f ||
        ...
        return (
          (m.destroy = function () {
            c &&
              ...
              e.removeEventListener("popstate", y, !1),
              m.cancelScroll(),
              (c = null),
              (p = null),
              (u = null),
          ...
          (m.init = function (o) {
            ...
            m.destroy(),
              ...
              u && e.addEventListener("resize", k, !1),
              c.updateURL &&
                c.popstate &&
...
const menuButton = $(".menu-button"),
  ...
  mobileBar = $(".mobile-navbar");
function handleMenu(e) {
  e.preventDefault(),
    darkOverlay.toggleClass("visible"),
    mobileMenu.toggleClass("visible"),
    mobileBar.toggleClass("visible");
}
function handleToggleMenu(e) {
  e.preventDefault();
  const t = $(this);
  t.parent(".has-submenu").toggleClass("opened"),
    t.next("ul").slideToggle(500, function () {
...
let arrows = $(".arrows"),
  open = !1;
function handleToggleArrows() {
  const e = $(this);
  open
    ? arrows.find(".fa").removeClass("open")
    : e
        .find(".fa")
        .toggleClass("open")
        .closest("li")
...
$(document).on("click", ".arrows", handleToggleArrows),
  window.addEventListener("scroll", function () {
    let e = document.querySelector("#navbar"),
      t = document.querySelector(".mobile-navbar");
    e.classList.toggle("sticky", window.scrollY > 400),
      t.classList.toggle("sticky", window.scrollY > 400);
  });
const scroll = new SmoothScroll("a.smooth-scroll-link", {
    header: "[data-scroll-header]",
    speed: 1e3,
  }),
  newItems = document.querySelectorAll(".menu-desktop__link");
function handleScrollStop(e) {
  e.detail.anchor;
  const t = e.detail.toggle;
  newItems.forEach((e) => e.classList.remove("active")),
...
function initDesktop() {
  resetMobileMemu(), console.log("is-desktop");
}
document.addEventListener("scrollStop", handleScrollStop),
  ssm.addStates([
    {
      id: "mobile",
    ...
    {
      id: "tablet",
      query: "(min-width: 641px) and (max-width: 991px)",
      onEnter: function () {
        initTablet();
      },
    },
...
const settings = {
    ...
    speed: 1e3,
    prevArrow:
      "<button class='myarrows__item myarrows__item_prev'><i class='fa fa-chevron-left'></i></button>",
    nextArrow:
      "<button class='myarrows__item myarrows__item_next'><i class='fa fa-chevron-right'></i></button>",
    mobileFirst: !0,
    responsive: [
      { breakpoint: 569, settings: { slidesToShow: 2 } },
      { breakpoint: 767, settings: { slidesToShow: 3 } },
      { breakpoint: 991, settings: { slidesToShow: 4 } },
    ],
  },
  slOne = $("#slider-one");
slOne.slick(settings);
const settingsDots = {
    autoplay: !0,
    autoplaySpeed: 2e3,
    slidesToShow: 1,
  ...
  slTwo = $("#slider-two");
slTwo.slick(settingsDots);
const center = [29.758554735753883, -95.35499931586224],
  center1 = [29.754613, -95.356479],
  map = L.map("map");
...
L.marker(center /* , { icon: pinkIcon } */)
  ...
  .openPopup();
const circle = L.circle(center1, {
  radius: 100,
  color: "violet",
  fillColor: "green",
  fillOpacity: 0.5,
});
circle.addTo(map).bindPopup("Minute Maid Park");
const popup = L.popup();
...
const form = document.querySelector(".footer__form"),
  ...
  emailError = document.querySelector("#mail + span.error");
function showError() {
  email.validity.valueMissing
    ? (emailError.textContent = "You need to enter an e-mail address.")
    : email.validity.typeMismatch
    ? (emailError.textContent = "The e-mail address entered is invalid.")
...
document.addEventListener("keyup", function (e) {
  ...
  document.addEventListener("submit", function (e) {
    if ("loginform" !== e.target.name) return !1;
    email.validity.valid || (showError(), e.preventDefault());
  });
